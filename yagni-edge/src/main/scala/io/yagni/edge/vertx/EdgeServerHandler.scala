...
import java.nio.charset.{CodingErrorAction, StandardCharsets, CharsetDecoder}
import java.net.URL
...
class EdgeServerHandler(private var yagni: EdgeServer) {

  def getRestHttpHandler(): Handler[HttpServerRequest] = new YagniRestHttpHandler()
  ...
  private class YagniRestHttpHandler extends Handler[HttpServerRequest] {
