...
_PROPERTYDEFINITION = descriptor.Descriptor(
...
_RESPONSETYPE = descriptor.Descriptor(
  name='ResponseType',
...
_CONTAINEDDEVICE = descriptor.Descriptor(
...
_PROPERTYUPDATE = descriptor.Descriptor(
  name='PropertyUpdate',
...
class ContainedDevice(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
...
class PropertyUpdate(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
